...
chrommap_path = '/home/croth/Hypermutator_QTL/GENOTYPE/H99_chrommap.csv.gz'
...
geno_path ='/home/croth/Hypermutator_QTL/GENOTYPE/Bt65xH99_F1_progeny-SNPS.csv.gz'
genos = pd.read_csv(geno_path,index_col=0)
genos = genos.merge(chrommap[['Contig','Chrom','Seqid']])
...
## Seperate the gff for just QTL
chrm = 3
left = 881808-1000
right = 1118629+1000
gff = gff[(gff.Chrom == chrm) & (gff.Start>=left) & (gff.End<=right)]
...
savepath = '/home/croth/Hypermutator_QTL/GENOTYPE/GENES/'
savepath_sample = savepath+'P%s/'%samplename
...
# In[18]:
info_cols = ['Pos','Seqid','Contig','DPmin','Alt','Ref',
            'Type','Altlen','Qual','AF','Chrom','NALT']
